    ...
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
        <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
            ...
            <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
                ...
                Voluptatum enim suscipit labore ducimus facere veniam ut nulla distinctio eligendi, 
                placeat consequatur vitae eveniet, incidunt blanditiis corporis doloribus. Autem,
                tenetur nam.
            </p>
        ...
        <div className='py-2 flex-1 flex items-center relative'>
            ...
            <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:grid-cols-2 lg:px-[30px] py-4 gap-4 flex-wrap '>
                {
